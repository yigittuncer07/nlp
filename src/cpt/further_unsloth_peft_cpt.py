...
OUTPUT_DIR = f"/media/drive1/{MODEL_NAME.split('/')[-1]}-mevzuat-cpt"
DATA_PATH='/media/drive1/mevzuat_dataset_text_only'
WANDB=True
if WANDB:
    wandb.login()
    config = {
...
dataset = dataset.train_test_split(train_size = 0.99)["train"]
